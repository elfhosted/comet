...
## [1.6.0](https://github.com/elfhosted/comet/compare/v1.5.0...v1.6.0) (2024-07-05)


### Features

* add logger. refactor main.py. move settings. ([36f2a82](https://github.com/elfhosted/comet/commit/36f2a827bf48fa4c5d5bdb581aa00b503a9a1be4))
* add option to toggle title checking ([bbb257d](https://github.com/elfhosted/comet/commit/bbb257dda87875bfcb0d236d1cd82e9a3781fdef))
* create test ([df020e4](https://github.com/elfhosted/comet/commit/df020e4f614d5a4506e4f08f96c96d82463de876))
* environment variable for custom addon ID (ADDON_ID) ([d2b7ee8](https://github.com/elfhosted/comet/commit/d2b7ee84bd96f5f8d4f5bbb0abd96ab4d3f24833))
* insane new debrid stream proxy (allows to use debrid service on multiple IPs at same time) ([ba1f78e](https://github.com/elfhosted/comet/commit/ba1f78eb84fda5e4d3b9f488d5fbde46fa57317d))
* lot of fixes, caching system changed, camel to snake etc... ([9cf3346](https://github.com/elfhosted/comet/commit/9cf3346ed5992ba5ecc88c82530fab91331cc089))
* new debrid manager and cleaning (ruff) ([c48e466](https://github.com/elfhosted/comet/commit/c48e4661298d7425627ec03510efbcde19c46b2a))
* restructured/refactored/reorganized ([299c721](https://github.com/elfhosted/comet/commit/299c7217e4df00814cc2635fb5d05e54f6874df9))
* restructured/refactored/reorganized ([b02d84c](https://github.com/elfhosted/comet/commit/b02d84c36e53faf23760abe88ebb43a4cb9f3432))


### Bug Fixes

* 0.30ms faster :pro: ([6b1daa6](https://github.com/elfhosted/comet/commit/6b1daa61a0106d6557047059348ab6e7caecb693))
* add additional logging ([1d0597a](https://github.com/elfhosted/comet/commit/1d0597ac1641aae1867741906b03428f45725faa))
* aiohttp max number of simultaneous connections ([9309e15](https://github.com/elfhosted/comet/commit/9309e15a121feb69310cb8a3533447cde3b453ad))
* correct compose files ([11430b4](https://github.com/elfhosted/comet/commit/11430b447e42aacc0c126db871154c2c3a0e2eec))
* only show stars for non mobile users (performance issue) ([7415984](https://github.com/elfhosted/comet/commit/741598497eedbb4be3c75e89470077e68ed3528d))
* please fix ([184e24f](https://github.com/elfhosted/comet/commit/184e24f865c5f9bf4ce90eaa59095b64f4ecc372))
* real debrid error ([704f841](https://github.com/elfhosted/comet/commit/704f8419cd3107bc5efaa5e9befa36063bb96dd5))
* remove random print ([2b74a50](https://github.com/elfhosted/comet/commit/2b74a5053d79a498a2a216cd0107bda2ce177d9a))
* remove the useless test file ([f8a9998](https://github.com/elfhosted/comet/commit/f8a9998f7ad906795660af0137ba7cf8d452bbe8))
* replaced os with pydantic for env getters ([d5b7632](https://github.com/elfhosted/comet/commit/d5b76327db2eb0c40d90c97b86573260b145b1d0))
* smooth loading + fixed empty select (web) ([f9dd917](https://github.com/elfhosted/comet/commit/f9dd91719883d08dbac531cec8ac0ca7a4b45e88))
* test ([174aa65](https://github.com/elfhosted/comet/commit/174aa655053262b1f3b6174463b8f11ed3f2b298))
* that's how you release it hehe ([ad65d1f](https://github.com/elfhosted/comet/commit/ad65d1f99e9996f06d88b27c168d70b3b3998126))
* title ([e841f08](https://github.com/elfhosted/comet/commit/e841f081bda10fbe74284ed87e5655bd60b8f3b2))
* try to fix session unclosed issue with debrid stream proxy ([1f63113](https://github.com/elfhosted/comet/commit/1f63113d8d418a8101cea925625f6d1d0cef5cf7))
* unset local variable ([c8b6736](https://github.com/elfhosted/comet/commit/c8b673643a7da9c49f81f0965c620350c81ba799))
